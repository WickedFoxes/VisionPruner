...
from llava_lp.mm_utils import tokenizer_image_token, process_images, get_model_name_from_path
...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_eval_model(args, model_path, model_name)
    if getattr(args, "vision_pruner_debug_weights_only", False):
        return
    ...
    for (input_ids, image_tensor, image_sizes), line in tqdm(zip(data_loader, questions), total=len(questions)):
        ...
        with torch.inference_mode():
            output_ids = model.generate(
                ...
                **build_generation_kwargs(args, args.max_new_tokens))
